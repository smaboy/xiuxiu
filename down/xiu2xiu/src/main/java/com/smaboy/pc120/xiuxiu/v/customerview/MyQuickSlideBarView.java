package com.smaboy.pc120.xiuxiu.v.customerview;
...
/**
 * Created by Smaboy on 2017/12/15-13:48.
...
public class MyQuickSlideBarView extends View {

        private OnMyQuickSideBarTouchListener listener;
        ...
        public MyQuickSlideBarView(Context context) {
            this(context, null);
        }

        public MyQuickSlideBarView(Context context, AttributeSet attrs) {
            this(context, attrs, 0);
        }

        public MyQuickSlideBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        public OnMyQuickSideBarTouchListener getListener() {
            return listener;
        }

        public void setOnQuickSideBarTouchListener(OnMyQuickSideBarTouchListener listener) {
