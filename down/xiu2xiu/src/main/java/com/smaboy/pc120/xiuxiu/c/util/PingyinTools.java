...
public class PingyinTools {
    ...
    private static PingyinTools sInstance;
    ...
    protected PingyinTools(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static PingyinTools getInstance() {
        synchronized (PingyinTools.class) {
            if (sInstance != null) {
                return sInstance;
            }
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA)) {
                    ...
                    sInstance = new PingyinTools(true);
                    return sInstance;
                }
            }
            Log.w(TAG, "There is no Chinese collator, HanziToPinyin is disabled");
            sInstance = new PingyinTools(false);
            return sInstance;
        }
    }
